 ...
 */
class German_LocalePackAt_Model_Observer {

    public function adminhtmlControllerActionPredispatchStart() {

        $helper = Mage::helper("localepackat");
    ...
    {
        return (string)Mage::app()->getConfig()->getNode('modules/German_LocalePackAt/version');
    }
    ...
    public function getManageUrl(){
        return Mage::helper("adminhtml")->getUrl('adminhtml/system_config/edit', array('section'=>'localepackat'));
    }
}
